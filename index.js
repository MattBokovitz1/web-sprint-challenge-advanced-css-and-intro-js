...
function getArtistByIndex(array, index) {
    for(let i=0; i<array.length; i++){
      if(index === i){
        console.log(`The artist at index ${index} is ${array[i].name}`)
        return array;
      }
    }
  }
...
function addArtist(idN, nameN, yearsN, genreN, nationalityN, bioN){
  artists.push = {
    id: idN,
    name: nameN,
    years: yearsN,
...
addArtist(artists, 20, "Matt", "1996 - 2020", "Web Design", "American", "lorem ipsum");
console.log(artists);
